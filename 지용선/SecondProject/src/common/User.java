...
public class User {
	...
	public String toString() {
		return userName +" ´ÔÀÇ ÀÜ¾× : " + cash.getRemainCash() + " ¿ø, ±¸¸Å ¾ÆÀÌÅÛ °¹¼ö : " +
			   (holdItem.getHoldItemCntByCodeCount(CommonConst.ITEMCODE2222,UseState.Á¤»ó) + holdItem.getHoldItemCntByCodeCount(CommonConst.ITEMCODE2222,UseState.»ç¿ë)) + 
